        ...
        <FullWidthLayout title="Willkommen" showTitle={false}>
            ...
            <div className={cn("bg-gray-200 dark:bg-gray-700 transition-all duration-500 ease my-8")}>
                <ul className={cn("grid grid-cols-2 lg:grid-cols-3 gap-px")} aria-roledescription="navigation">
                    <li><GridLinkItem icon={<TbSalad className="size-6 mt-1 text-primary" />} title="Vorspeisen" punchline="für den kleinen Hunger" buttonText="Zu den Vorspeisen" /></li>
                    <li><GridLinkItem icon={<PiCookingPot className="size-6 mt-1 text-primary" />} title="Hauptgerichte" punchline="für den großen Hunger" buttonText="Zu den Hauptgerichten" /></li>
                    <li><GridLinkItem icon={<GiCakeSlice className="size-6 mt-1 text-primary" />} title="Nachtisch" punchline="für ein süßes Ende" buttonText="Zum Nachtisch" /></li>
                    <li><GridLinkItem icon={<LiaCocktailSolid className="size-6 mt-1 text-primary" />} title="Cocktails" punchline="für einen schönen Abend" buttonText="Zu den Cocktails" /></li>
                    <li><GridLinkItem icon={<RiCake3Line className="size-6 mt-1 text-primary" />} title="Backen" punchline="für eine gute Zeit" buttonText="Zum Backen" /></li>
                    <li><GridLinkItem icon={<GiCrystalBars className="size-6 mt-1 text-primary" />} title="Snacks" punchline="für zwischendurch" buttonText="Zu den Snacks" /></li>
                </ul>
            </div>
            <Seperator />
