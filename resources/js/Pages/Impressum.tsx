    ...
    return (
        <>
            ...
            <TwoSidebarsLayout title="Impressum" leftSidebar={<LeftSidebar />} rightSidebar={<RightSidebar />}>
                <h3 className="my-5"><strong>Angaben gemäß § 5 TMG:</strong></h3>
                <ul className="space-y-1 my-3 font-roboto">
                    ...
                    <li><a href="mailto:mail@tobias-hopp.de" target="_blank" rel="noopener noreferrer">E-Mail</a></li>
                </ul>
                    

                    <h3 className="my-5"><strong>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</strong></h3>
                    <p>
                        Tobias Hopp<br />
