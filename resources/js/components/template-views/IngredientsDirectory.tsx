...
export default function IngredientsDirectory() {
    ...
    return (
        <div className="space-y-8">
            ...
            <Accordion type="single" collapsible className="p-0 rounded-sm my-5 border border-transparent border-b-gray-200 dark:border-b-gray-700 bg-gray-100 dark:bg-gray-900">
