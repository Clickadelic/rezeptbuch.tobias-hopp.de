    ...
    return (
        <SidebarLeftLayout title="Nutzungsbedingungen" sidebar={<LegalSidebar />}>
            ...
            <section>
                ...
                <p>
                    Die angebotenen Inhalte (Rezepte, Texte, Bilder etc.) dienen ausschließlich zu
                    privaten Informationszwecken. Eine kommerzielle Nutzung oder Weiterverwendung
                    der Inhalte ist ohne ausdrückliche Zustimmung nicht gestattet.
                </p>
            </section>
            <section>
            ...
            <section>
                ...
                <p>
                    Sofern personenbezogene Daten (z. B. Name, E-Mail) gespeichert werden, erfolgt
                    dies freiwillig und ausschließlich zur Nutzung der Funktionen des Rezeptbuchs.
                    Es werden keine Daten an Dritte weitergegeben. Weitere Informationen findest du
            ...
            <section>
                ...
                <p>
                    Der Betreiber (Tobias Hopp) behält sich vor, diese Nutzungsbedingungen jederzeit
            ...
            <section>
                ...
                <p>
                    Bei Fragen oder Hinweisen kannst du dich per E-Mail an den Betreiber wenden:
                    <a
