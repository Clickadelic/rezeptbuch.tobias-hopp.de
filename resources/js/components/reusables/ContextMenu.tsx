...
export default function ContextMenu({ recipe }: ContextMenuProps) {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger
                className="absolute top-2 right-0 text-gray-600 dark:text-gray-200 p-1 hover:text-gray-300 hover:cursor-pointer shadow-transparent z-20 rounded-full hover:bg-white/30 dark:hover:bg-gray-800/30"
