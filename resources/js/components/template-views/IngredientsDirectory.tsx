        ...
        <div className="space-y-8">
            ...
            {alphabet.map(
                (letter) =>
                    grouped[letter] && (
                        <>
                            <section key={letter} id={letter} className="scroll-mt-24 p-4 rounded-md transition-all duration-200 hover:bg-slate-100 dark:hover:bg-slate-900 hover:cursor-default">
                                <Card>
