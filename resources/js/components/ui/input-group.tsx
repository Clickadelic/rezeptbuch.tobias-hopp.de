...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            role="group"
            className={cn(
                'group/input-group border border-gray-200 dark:border-gray-700 relative flex w-full items-center rounded-md transition-[color,box-shadow] outline-none',
                ...
                // Focus state.
                'has-[[data-slot=input-group-control]:focus-visible]:border-emerald-800',
