      ...
      <Card className="max-w-2xl w-full bg-background border shadow-lg">
        <CardContent className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-4">
          <p className="text-sm text-muted-foreground leading-snug">
            🍪 Diese Website verwendet nur technisch notwendige Cookies, z.&nbsp;B. für Login
            und Sicherheit. Es werden <strong>keine Tracking- oder Werbe-Cookies</strong> verwendet.{" "}
            <a
              href="/cookie-hinweis"
