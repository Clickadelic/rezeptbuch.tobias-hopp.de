    ...
    return (
        <NoSidebarsLayout title="App Installation" showTitle={false} description="Schritt für Schritt, die Rezeptbuch-App installieren. Jetzt erhältlich für iOS und Android.">
            <div className="w-full flex gap-3 justify-start items-center">
                <TitleBlock title="App Installation" punchline="Einfach auf Dein Smartphone" icon={<AiOutlineAppstoreAdd className="text-primary size-6 mt-1" />} />
            
                {/* <div className="w-full flex flex-col items-center justify-center gap-2">
                    <img src={imgSrc} className="w-96 mx-auto" alt="Chef Tobias" />
                    <p>Im Folgenden findest Du die Anleitung zur Installation der App auf Dein Smarphone.</p>
                    <br />
                    <p>Drücke in Deinem mobilen Browser auf die Schaltfläche für weitere Einstellungen.</p>
