            ...
            <FullWidthLayout title="Dashboard">
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 grid-rows-5 gap-2 md:galg:gap-4">
                    <div className="md:col-span-4 lg:col-span-3 lg:row-span-2 rounded-xl ">
                        <h2 className="text-lg font-medium mb-3">Willkommen zurück, { auth.user.name }</h2>
                        
                        <p>Aktuell gibt es hier noch nicht allzu viel zu sehen, das wird sich aber mit der Zeit hoffentlich ändern.</p>
                        <p>Mehr Funktionen sind in der Zukunft geplant, mal sehen, was sich so ergibt.</p>
                    </div>
                    <div className="md:col-span-2 md:col-start-1 lg:col-span-1 lg:row-span-2 lg:col-start-4 rounded-xl ">
                        <h2 className="text-lg font-medium">Gerichte { dishCount as number }</h2>
                        <p className="text-sm text-slate-500">Es gibt insgesamt { dishCount as number } Gerichte.</p>
                    </div>
                    <div className="md:col-span-2 md:col-start-3 lg:col-span-1 lg:row-span-2 lg:col-start-5 rounded-xl ">
                        <h2 className="text-lg font-medium">Cocktails X</h2>
