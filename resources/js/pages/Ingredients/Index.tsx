...
export default function IngredientsIndex() {
    return (
        <NoSidebarsLayout
            title="Zutaten"
            description="Hier findest Du alle Zutaten des Rezeptbuchs."
        >
            <div className="grid grid-cols-1 sm:grid-cols-3 mb-5">
                ...
                <div className="w-full col-span-1 sm:col-span-4 sm:col-start-2">
                    <p>
                        Gute Zutaten sind die Grundlage für ein gesundes und leckeres Essen. Das
                        Gleiche gilt natürlich auch für Getränke aller Art, frei nach dem Motto:
                    </p>
                    <br />
                    <p className="italic">
                        "Es ist genau so wichtig, was in Deinen Mund rein geht, wie das was raus
                        kommt."
                    </p>
                    <br />
