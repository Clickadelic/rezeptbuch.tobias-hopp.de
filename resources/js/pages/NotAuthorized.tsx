...
export default function NotAuthorized() {
    return (
        <FullWidthLayout
            ...
            description="Wenn Du nicht angemeldet bist, bist Du nicht angemeldet."
        >
            <div className="flex flex-col sm:flex-row-reverse justify-center items-center gap-5">
                <img
                    src={missionImpossibleBro}
                    className="w-full sm:w-1/2 max-w-96"
                    alt="Mission Impossible - Nicht eingeloggt"
                />
