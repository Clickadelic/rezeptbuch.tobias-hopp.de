...
export default function RecipeSearch() {
    ...
    return (
        <div className="w-full h-48 lg:h-64 bg-[url('../images/brooke-lark-kXQ3J7_2fpc-unsplash.jpg')] dark:bg-[url('../images/brooke-lark-M4E7X3z80PQ-unsplash-cut.jpg')] bg-cover bg-center flex flex-col justify-center items-center">
