      ...
      <Modal show={confirmingUserDeletion} onClose={closeModal}>
        <form onSubmit={deleteUser} className="p-6">
          ...
          <p className="mt-1 text-sm text-gray-600">
            Wenn Dein Profil gelöscht wird, werden alle Deine Daten und Einstellungen permanent
            gelöscht. Dies kann nicht wiederhergestellt werden. Bitte gib' daher Dein Passwort ein
            um Dein Profil wirklich zu löschen.
          </p>
          <div className="mt-6">
