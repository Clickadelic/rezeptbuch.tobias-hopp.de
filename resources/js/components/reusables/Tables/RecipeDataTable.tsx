 ...
 */
export const RecipeDataTable: React.FC<RecipeDataTableProps> = ({ data, tableClasses }) => {
    if (!data || !data.data || data.data.length === 0) {
      return (
          <div className="p-4 bg-gray-100 dark:bg-gray-900 rounded-xl border-b border-gray-200 dark:border-gray-700">
