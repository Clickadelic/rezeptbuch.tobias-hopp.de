        ...
        <SidebarLeftLayout title="Impressum" sidebar={<LegalSidebar />}>
            ...
            <section>
                ...
                <ul className="list-disc list-inside">
                    ...
                    <li>Headerbild: Darkmode Foto von <a href="https://unsplash.com/de/@lottiegriffiths?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" className="underline underline-offset-4 text-primary" target="_blank">Lottie Griffiths</a> auf <a href="https://unsplash.com/de/fotos/braunes-essen-auf-weissem-keramikteller-8op0ziM4Xzs?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText" className="underline underline-offset-4 text-primary" target="_blank">Unsplash</a></li>
