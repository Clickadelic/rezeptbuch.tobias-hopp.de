...
export default function BigRecipeCard({ recipe, className }: BigRecipeCardProps) {
    return (
        <Card className={cn('shadow-xs hover:shadow-md animate ease-in-out duration-300 flex flex-col bg-gray-100 dark:bg-gray-900 p-0 rounded-b-xl border-b border-gray-200 dark:border-gray-700', className)}>
