    ...
    return (
        <Link
            ...
            className={`flex w-full items-start border-l-4 py-2 pe-4 ps-3 ${
                active
                    ? 'border-primary bg-emerald-50 text-primary focus:border-primary focus:bg-emerald-100 focus:text-emerald-800'
                    : 'border-transparent text-gray-800 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-800 focus:border-primary focus:bg-emerald-50 focus:text-gray-800 dark:text-gray-200 dark:focus:bg-gray-700 dark:focus:text-gray-200'
